...
const ru = {
  ...
  auth: {
    ...
    loading: 'Загрузка…',
    favorites: 'Избранное',
    pickUsername: 'Выберите логин',
    usernameHint: 'Логин используется в адресе вашей карты: /@логин',
    usernamePlaceholder: 'например: ivan_petrov',
    usernameRequired: 'Введите логин',
    usernameSaveError: 'Не удалось сохранить логин',
    skipForNow: 'Позже',
    saving: 'Сохранение…',
    save: 'Сохранить',
    myMap: 'Моя карта',
  ...
  favorites: {
    ...
    loading: 'Загрузка…',
    empty: 'Вы ещё не добавили карты в избранное.\nПопробуйте найти пользователя по имени или логину выше.',
