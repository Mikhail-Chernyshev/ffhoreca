...
const ru = {
  ...
  manager: {
    ...
    showOnMap: 'На карте',
    ariaShowOnMap: 'Показать «{{name}}» на карте',
  ...
  feedback: {
    link: 'Обратная связь',
    expand: 'Развернуть обратную связь',
    collapse: 'Свернуть обратную связь',
    intro: 'Вопросы, идеи и баги — напишите напрямую или через форму ниже.',
    emailLabel: 'Почта',
    ...
    sendError: 'Не удалось отправить. Попробуйте позже или напишите на почту.',
  },
  report: {
    title: 'Пожаловаться на место',
    subtitle: '«{{name}}» на карте @{{username}}',
    reasonLabel: 'Причина',
    nameLabel: 'Имя',
    namePlaceholder: 'Как к вам обращаться',
    emailLabel: 'Email',
...
const en = {
  ...
  manager: {
    ...
    showOnMap: 'On map',
    ariaShowOnMap: 'Show «{{name}}» on the map',
  ...
  feedback: {
    ...
    sendError: 'Could not send. Try again later or email us directly.',
  },
  report: {
    ...
    messagePlaceholder: 'What violates the rules? Required for “Other”.',
    ...
    reason: {
      ...
      violence: 'Violence or extremism',
